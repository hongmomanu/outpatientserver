(ns outpatientserver.core
  (:require [outpatientserver.handler :refer [app init destroy]]
            [immutant.web :as immutant]
            [outpatientserver.db.migrations :as migrations]
...
(defn start-http-server [port]
  (init)
  (reset! http-server (immutant/run app :port port :host "0.0.0.0")))
